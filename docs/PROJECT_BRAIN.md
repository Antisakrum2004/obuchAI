...
> Срез проекта на 2026-06-15 (обновлено до v0.30.0 — динамический дашборд: API learning-path, кликабельная дорожная карта, привязка модулей к реальным статьям, защита от накрутки XP). Для нового разработчика или AI — понять проект за 3-5 минут без чтения всего кода.
>
