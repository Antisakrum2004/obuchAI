...
> Срез проекта на 2026-06-15 (обновлено до v0.27.0 — QuizBlock: таймер 30с, по одному вопросу, violet цвета, нормализация correct/correctIndex). Для нового разработчика или AI — понять проект за 3-5 минут без чтения всего кода.
>
